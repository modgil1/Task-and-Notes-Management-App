            ...
            function parseMenu(ul, menu) {
                for (var i = 0; i < menu.length; i++) {
                    ...
                    if (menu[i].sub != null) {
                        ...
                        var updateButton = $("<input type='button' value='update' class='btn btn-warning update' id = '" + idforli + "' data-toggle='modal' data-target='#signup' style='margin-left:24px;'><br/><br />")
